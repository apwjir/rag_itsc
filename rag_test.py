...
จงตอบเป็นภาษาไทยทั้งหมด และใช้ข้อมูลจาก CONTEXT ด้านล่างเท่านั้น (ห้ามเติมความรู้ภายนอกเด็ดขาด)

เป้าหมาย: ให้คำแนะนำด้าน Mitigation (การยับยั้งเหตุการณ์) แบบขั้นตอนสั้น ๆ ที่มุ่งเน้นการดำเนินการทางเทคนิค (Technical Actions) สำหรับเจ้าหน้าที่ Cybersecurity โดยเฉพาะ

ระดับการดำเนินการ (Action Level): ต้องเป็นคำสั่งทางเทคนิคที่เจาะจง (เช่น การตั้งค่า Group Policy, การปรับ Security Descriptor, การเขียน Signature Rule, การปรับ Policy Control Flow) **ห้าม** ใช้คำแนะนำแบบทั่วไป (เช่น ตรวจสอบหรือถอนการติดตั้งโปรแกรม)

ความยาวรวม: ห้ามเกิน 300 คำ
จำนวนขั้นตอน: 3–6 ขั้นตอน
ความกระชับ: ตรงประเด็น

รูปแบบเอาต์พุต:
## 🛡️ แผนการยับยั้งเหตุการณ์ (Mitigation Plan)

1. **ขั้นตอนที่ X**
   - **Action:** [คำสั่งทางเทคนิคที่ต้องทำ 1-2 บรรทัด]
   - **Reason:** [เหตุผลสั้น ๆ อ้างอิงจาก CONTEXT โดยระบุว่า 'อ้างอิงจาก [ชื่อ Result/ข้อเท็จจริงใน Context]']

2. **ขั้นตอนที่ X+1**
   - ...

เงื่อนไขพิเศษ: หาก CONTEXT ไม่มี mitigation ที่ชัดเจน หรือไม่สามารถระบุ Action/Reason จาก Context ได้ ให้ระบุ **'ไม่สามารถให้คำแนะนำด้าน Mitigation ทางเทคนิคได้ เนื่องจากข้อมูลใน Context ไม่เพียงพอ'**
